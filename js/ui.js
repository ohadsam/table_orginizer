...
const UI = (() => {
  ...
  const _HINTS = [
    ...
    { id: 'hint_deps',       text: 'הגדר קשרים בין מוזמנים (🔗 בסרגל המוזמנים) — זוגות, גרושים, פרודים וקונפליקטים מובאים בחשבון בשיבוץ האוטומטי.' },
    { id: 'hint_inference',  text: 'בלשונית "הוסף קשר" בתרשים הקשרים — לאחר בחירת מוזמן א׳, פאנל "הצעות חכמות" בצד מציע קשרים לוגיים נוספים בהתבסס על הרשת הקיימת.' },
    { id: 'hint_dep_graph',  text: 'בתרשים הקשרים יש 3 תצוגות: 🔵 עיגול, 🔤 אלפביתי ו-📊 לפי קטגוריה. השתמש בחיפוש לאיתור מוזמן ספציפי.' },
    { id: 'hint_infer_rules', text: 'בלשונית "⚙️ כללי היסק" בתרשים הקשרים תוכל להגדיר ולשנות כללים אוטומטיים — למשל: משפחה + משפחה → הצעה לקשר משפחה.' },
    { id: 'hint_dep_bulk',   text: 'בלשונית "➕ הוסף קשר" ניתן לבחור מוזמן א׳ ואחר כך לסמן מרובה ב׳ — קשרים לכל הנבחרים נוצרים בלחיצה אחת.' },
    { id: 'hint_dep_cats',   text: 'כל קשר משויך לקטגוריה (משפחה/חברים/בנפרד וכו׳). קטגוריה זו קובעת אם ואיזה קשר יוצע בהסקה אוטומטית.' },
